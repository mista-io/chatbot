...
<html lang="{{ app()->getLocale() }}">
	<head>
		...
		<!-- Bootstrap -->
		<link type="text/css" rel="stylesheet" href="{{ asset('public/install/css/bootstrap.min.css') }}"/>
        <link type="text/css" rel="stylesheet" href="{{ asset('public/css/select2.css') }}">
		
		<!-- Custom stlylesheet -->
		<link type="text/css" rel="stylesheet" href="{{ asset('public/install/css/style.css') }}"/>
	...
	<body>
		...
		<!-- jQuery Plugins -->
		<script type="text/javascript" src="{{ asset('public/install/js/jquery.min.js') }}"></script>
		<script type="text/javascript" src="{{ asset('public/install/js/bootstrap.min.js') }}"></script>
